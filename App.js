...
export default class App extends React.Component{
    ...
    render(){
        ...
        <Text style={[styles.text,{backgroundColor: 'green'}]}>Palabra:{''}</Text>
        <Text style={[styles.text,{fontSize: 15}]}>{this.state.word}</Text>

        <Text style={[styles.text,{backgroundColor: 'green'}]}>Tipo:{''}</Text>
        <Text style={[styles.text,{fontSize: 15}]}>{this.state.lexicalCategory}</Text>

        <Text style={[styles.text,{backgroundColor: 'green'}]}>Definicion:{''}</Text>
